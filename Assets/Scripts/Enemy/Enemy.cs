...
namespace Enemy
{
    public class Enemy : MonoBehaviour
    {
        ...
        public Hexagon.Hexagon[] hexagons;
        ...
        public Stack<GameObject> CalculatePath()
        {
            ...
            hexagons = FindObjectsOfType<Hexagon.Hexagon>();
            ...
            {
                curHex.GetComponent<Hexagon.Hexagon>().SetVisited();                                                                 // и отметить его как посещенный.
                ...
                while (curHex.transform.position != targetHexagon.transform.position)                                        // Пока гекс моба не совпадает с гексом игрока
                {
                    List<GameObject> freeUnVisitedNeighbours =
                        ReturnFreeUnVisitedNeighbours(curHex.GetComponent<Hexagon.Hexagon>().ReturnFreeNeighbours());
        ...
        private List<GameObject> ReturnFreeUnVisitedNeighbours(List<GameObject> freeNeighbours)
        {
            ...
            { 
                if (!neighbour.GetComponent<Hexagon.Hexagon>().IsVisited())
                {
